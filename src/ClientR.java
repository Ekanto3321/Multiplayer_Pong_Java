...
public class ClientR extends JFrame {
        ...
        try {
            ...
            while (true) {
                ...
                if(receivedCoordinates!=null){
                    ...
                    p.setDrawingData(Integer.parseInt(s[1]),Integer.parseInt(s[0]),Integer.parseInt(s[2]),Integer.parseInt(s[3]),Integer.parseInt(s[4]),Integer.parseInt(s[5]));
                    repaint();
                }
            }
